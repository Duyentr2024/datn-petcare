...
const Invoice = () => {
    ...
    return (
        <div className="container mx-auto p-1 bg-gray-50 min-h-screen">
            <h2 className="text-2xl font-bold text-gray-800 mb-3">Quản Lý Hóa Đơn</h2>
                    ...
                    <div className="flex-1 relative">
                        ...
                        <div className="relative">
                            <DatePicker
                                ...
                                className="w-full p-2 pl-10 border rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm"
                                maxDate={new Date()}
                            />
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p className="mt-1 p-2 bg-gray-100 rounded">{selectedOrder.customerName || "Khách vãng lai"}</p>
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-600">Số điện thoại</label>
                                <p className="mt-1 p-2 bg-gray-100 rounded">{selectedOrder.customerPhone || "Không có"}</p>
                            </div>
                        </div>
