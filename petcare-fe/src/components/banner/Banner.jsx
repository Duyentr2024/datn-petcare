...
import banner2 from "../../assets/images/BANNER1-02.png";
const Banner = () => {
...
const getSlideImage = (index) => {
    if (index === 0) {
        return banner; // Trả về đường dẫn ảnh đã import
    } else if (index === 1) {
        return banner2;
    }
    return ""; // Default return nếu index không hợp lệ
};
        ...
        >
          ...
          <div className="absolute bottom-4 left-4 transform flex space-x-4">
            <div
              ...
              className={`w-16 h-16 rounded-full cursor-pointer bg-cover bg-center ${
                currentIndex === 0
                  ? "border-4 border-"
