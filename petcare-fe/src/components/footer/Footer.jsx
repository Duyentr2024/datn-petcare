...
export default function RenderFooter() {
    ...
    return (
        <>
            ...
            <div className="bg-[#fef0d3] text-gray-800">

                <div className="container ml-20 mx-auto px-6 py-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pl-3 mt-10">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-gray-600 leading-6">
                                PetShop là cửa hàng chuyên cung cấp các sản phẩm chất lượng cho thú cưng, từ thực phẩm,
                                đồ
                                chơi,
                                đến các phụ kiện chăm sóc sức khỏe cho thú cưng. Chúng tôi cam kết mang lại những sản
                                phẩm
                                an toàn
                                và đáng tin cậy cho bạn và thú cưng yêu quý.
                            </p>
                            <p className="text-sm text-gray-600 leading-6">
                                Chứng nhận cửa hàng đạt tiêu chuẩn chất lượng do Bộ Nông Nghiệp và Phát Triển Nông Thôn
                                cấp
                                ngày
                                15/08/2023.
                            </p>
