        ...
        <div className="bg-gradient-to-r flex items-center justify-center min-h-screen ">
            <div
                ...
                <div className="p-10 items-center justify-center w-full lg:w-1/2 rounded-lg load-img hidden lg:flex">
                    <img src="https://placehold.co/600x600" alt="Logo with petcare"
                ...
                <div className="p-10 w-full lg:w-1/2 flex flex-col justify-center">
                    ...
                    <form onSubmit={handleRegister}>
                        ...
                        <div className="mb-4">
                            <div className="flex flex-col-reverse relative">
                                <input type={showPassword ? "text" : "password"} id="password" placeholder="Mật khẩu"
                                       className="peer outline-none border pl-2 py-2 pr-10 duration-500 border-gray-300 focus:ring-2 focus:ring-yellow-500 w-full rounded-lg shadow-md"
                                       value={formData.password} onChange={handleInputChange} required/>
                                <span className="pl-2 text-gray-500">Mật khẩu</span>
                                <i onClick={togglePasswordVisibility}
                                   className="absolute right-3 cursor-pointer bg-white p-1">
                                    {showPassword ? <EyeSlashIcon className="h-5 w-5 text-[#FBB321]"/> :
                        ...
                        <div className="mb-6">
                            <div className="flex flex-col-reverse relative">
                                ...
                                <i onClick={toggleConfirmPasswordVisibility}
                                   className="absolute right-3 cursor-pointer bg-white p-1">
                                    {showConfirmPassword ? <EyeSlashIcon className="h-5 w-5 text-[#FBB321]"/> :
                                        <EyeIcon className="h-5 w-5 text-[#FBB321]"/>}
                                </i>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <button type="submit"
                                    className="bg-yellow-500 text-white px-6 py-3 rounded-lg flex items-center group space-x-2 hover:bg-yellow-600 focus:ring-2 focus:ring-yellow-500 transition-all duration-300">
                                <span className="relative z-10">Đăng ký</span>
                                <FaArrowCircleRight
                                    className="h-5 w-5 group-hover:text-yellow-300 group-hover:translate-x-2"/>
                            </button>
                        </div>

                        <div className="text-center">
                            <span className="text-gray-500">Bạn đã có tài khoản? <Link to="/login"
                                                                                       className="text-yellow-500 hover:underline font-bold">Đăng nhập ngay</Link></span>
                        </div>
                    </form>
                </div>
            </div>
