            ...
            <div className="flex justify-center">
                <div className="w-full max-w-[1200px] h-[200px] relative overflow-hidden px-4 md:px-8"> {/* Added padding here */}
                    <div className="w-[25%] h-[200px] left-0 top-0 absolute overflow-hidden"> {/* Changed from fixed width to max-w-[1200px] */}
                        ...
                        <div className="w-[288px] h-[20px] left-[36px] top-[90px] absolute text-[#fbb321] text-sm font-bold font-['Quicksand'] leading-snug whitespace-nowrap">#PetCare</div>
                    ...
                    <div className="w-[25%] h-[200px] left-[25%] top-0 absolute overflow-hidden"> {/* Adjusted width and position */}
                        ...
                        <div className="w-[288px] h-[20px] left-[36px] top-[90px] absolute text-[#f2703e] text-sm font-bold font-['Quicksand'] leading-snug whitespace-nowrap">#Grooming</div>
                    ...
                    <div className="w-[25%] h-[200px] left-[50%] top-0 absolute overflow-hidden"> {/* Adjusted width and position */}
                        ...
                        <div className="w-[288px] h-[30px] left-[36px] top-[20px] absolute text-[#8a5e3b] text-[1.5rem] font-bold font-['Quicksand'] leading-normal whitespace-nowrap">Spa thú y</div>
                        ...
                        <div className="w-[288px] h-[20px] left-[36px] top-[90px] absolute text-[#8a5e3b] text-sm font-bold font-['Quicksand'] leading-snug whitespace-nowrap">#PetHotel</div>
                    ...
                    <div className="w-[25%] h-[200px] left-[75%] top-0 absolute overflow-hidden"> {/* Adjusted width and position */}
                        ...
                        <div className="w-[288px] h-[30px] left-[36px] top-[20px] absolute text-[#039aff] text-[1.5rem] font-bold font-['Quicksand'] leading-normal whitespace-nowrap">Thăm khám</div>
                        ...
                        <div className="w-[288px] h-[20px] left-[36px] top-[90px] absolute text-[#039aff] text-sm font-bold font-['Quicksand'] leading-snug whitespace-nowrap">#PetHealth</div>
